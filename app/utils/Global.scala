...
object Global extends GlobalSettings {
  ...
  override def onStart(app: Application): Unit = {
    ...
    def setupData(): Unit = {
      val user1 = createUser("daisuke-shimada@altplus.co.jp", "嶋田", "大輔", "daisuke-shimada", "https://lh5.googleusercontent.com/-t_SSgdNb9LM/AAAAAAAAAAI/AAAAAAAAAAA/5sUlkQ-eH6g/photo.jpg")
      val user2 = createUser("test@altplus.co.jp", "te", "st", "test", "https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg")
